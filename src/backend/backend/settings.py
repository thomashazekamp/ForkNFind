...
# Set DJANGO_SECRET_KEY in the environment (see .env.example). The fallback below
...
AUTH_USER_MODEL = 'forknfind.APIUser'
...
# Allow all origins, adjust as needed for your specific use case
