...
describe('SearchScreen', () => {
    ...
    it('Should have 3 children', () => {
        ...
        const tree = create(<SearchScreen />).toJSON();
    ...
    it('Should have 0 Establishments', () => {
        // render the review screen with a given data
        const { getByText } = render(<SearchScreen />);
        // check that the screen has rendered
        expect(getByText('0 Establishments')).toBeTruthy();
    });

    it('Should have All Relevance', () => {
        // render the review screen with a given data
        const { getByText } = render(<SearchScreen />);
        // check that the screen has rendered
        expect(getByText('All Relevance')).toBeTruthy();
    });
});