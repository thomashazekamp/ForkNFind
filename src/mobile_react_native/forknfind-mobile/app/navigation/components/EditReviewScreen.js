...
import UpdateRestaurantReview from '../requests/UpdateRestaurantReview';
...
const EditReviewScreen = ({ visible, onClose, id, reviewData, setReload }) => {
    ...
    const createReview = () => {
        ...
        if (starFive == true) {
            UpdateRestaurantReview(id, inputValue, 5, setResponse)
        } else if (starFour == true) {
            UpdateRestaurantReview(id, inputValue, 4, setResponse)
        } else if (starThree == true) {
            UpdateRestaurantReview(id, inputValue, 3, setResponse)
        } else if (starTwo == true) {
            UpdateRestaurantReview(id, inputValue, 2, setResponse)
        } else {
            UpdateRestaurantReview(id, inputValue, 1, setResponse)
        }
    }
    ...
    useEffect(() => {
        ...
        setInputValue(reviewData["description"]);
