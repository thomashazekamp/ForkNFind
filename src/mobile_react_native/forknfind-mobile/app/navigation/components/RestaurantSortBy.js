...
const RestaurantSortBy = ({ visible, onClose, setSortVisual}) => {
    ...
    const saveFilter = () => {
        ...
        if (radioButton == 1) {
            ...
            setSortVisual("Alphabetical (A - Z)")
        } else if (radioButton == 5) {
            setSortVisual("Alphabetical (Z - A)")
        } else if (radioButton == 6) {
            setSortVisual("Distance (Ascending)")
        } else if (radioButton == 7) {
            setSortVisual("Distance (Descending)")
        } 
        onClose();
    }
        ...
        <View style={{flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.7)'}}>
            <View style={styles.modalContainer}>
                <View style={styles.modalPadding} >
                    ...
                    <View style={styles.option}>
                        <Text style={styles.textOption}>Alphabetical (A - Z)</Text>
                        { radioButton == 4 ? 
                        <View style={styles.radioButtonSelected}>
                            <View style={styles.radioButtonSelectedMiddle}/>
                        </View>
                    ...
                    <View style={styles.option}>
                        <Text style={styles.textOption}>Alphabetical (Z - A)</Text>
                        { radioButton == 5 ? 
                        <View style={styles.radioButtonSelected}>
                            <View style={styles.radioButtonSelectedMiddle}/>
                        </View>
                    ...
                    <View style={styles.option}>
                        <Text style={styles.textOption}>Distance (Ascending)</Text>
                        { radioButton == 6 ? 
                        <View style={styles.radioButtonSelected}>
                            <View style={styles.radioButtonSelectedMiddle}/>
                        </View>
                        :
                        <TouchableOpacity onPress={() => setRadioButton(6)}>
                            <View style={styles.radioButton}/>
                        </TouchableOpacity>
                        }
                    </View>
                    <View style={styles.option}>
                        <Text style={styles.textOption}>Distance (Descending)</Text>
                        { radioButton == 7 ? 
                        <View style={styles.radioButtonSelected}>
                            <View style={styles.radioButtonSelectedMiddle}/>
                        </View>
                        :
                        <TouchableOpacity onPress={() => setRadioButton(7)}>
                            <View style={styles.radioButton}/>
                        </TouchableOpacity>
                        }
                    </View>
...
export default RestaurantSortBy